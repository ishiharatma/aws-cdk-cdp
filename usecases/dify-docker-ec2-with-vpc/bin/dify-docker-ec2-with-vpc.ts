...
const vpc = new DifyDockerEc2WithVpcStack(app, `DifyEC2VPCWithNATStack-${projectName}-${envName}`, {
    pjName: projectName,
    envName: envName,
    vpcCIDR: '10.0.0.0/16',
    isAutoDeleteObject: isAutoDeleteObject,
    description: 'Dify on Docker-Compose with VPC and custom NAT instance',
    env: defaultEnv,
