...
interface CloudFrontLoggingS3V2ConstructProps {
...
export class CloudFrontLoggingS3V2L1Construct extends Construct {

  constructor(scope: Construct, id: string, props: CloudFrontLoggingS3V2ConstructProps) {
    super(scope, id);
    ...
    const logsDeliveryDestination = new logs.CfnDeliveryDestination(this, 'LogsDeliveryDestination', {
      ...
      destinationResourceArn: props.loggingBucketArn,
    ...
    const logsDelivery = new logs.CfnDelivery(this, 'LogsDelivery', {
      ...
      s3SuffixPath: props.logPrefix ?? `{DistributionId}/{yyyy}/{MM}/{dd}/{HH}`,
