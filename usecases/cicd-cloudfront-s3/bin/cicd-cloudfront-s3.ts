...
new CicdCloudfrontS3Stack(app, 'CicdCloudfrontS3Stack', {
  input: {
    ...
    websiteBucketName: '',
    invalidationFunctionPath: path.join(__dirname, '../../common/src/lambda/cloudfront-create-invalidation'),
    distributionId: '',
    s3SyncFunctionPath: path.join(__dirname, '../../common/src/lambda/codedeploy-s3-sync'),
    snsNoticeTopicArn: '',
    lambdaLogLevel: 'INFO',
